  ...
  const projects = [
    {
      ...
      description:
        'Developed a responsive water purifier e-commerce platform with product listing, search, filters, and secure checkout. Integrated backend APIs and SEO-optimized, mobile-first UI for fast performance and better visibility.',
      tech: [
        'React',
        'Tailwind CSS',
        'Chart.js',
    ...
    },
    {
      ...
      title: 'Fit Club',
      description:
        'Collaborative task management application with drag & drop functionality, real-time updates, and team collaboration features.',
      tech: [
        'React',
        'Framer Motion',
        'Firebase',
    ...
    },
    {
      ...
      title: 'Trivago Clone',
      description:
        'Hotel metasearch application that compares prices across multiple booking platforms, helping users find the best hotel deals with a responsive and user-friendly interface.',
      tech: [
        'React',
        'API Integration',
        'Responsive Design',
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            A selection of projects showcasing my experience in React,
            modern UI development, and scalable frontend architecture.
          </p>
        </motion.div>
